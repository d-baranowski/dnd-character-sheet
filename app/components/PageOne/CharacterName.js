...
const CharacterName = () => (
  <g>
    ...
    <path id="top-banner-nav-start-piece-border"
          d="M41.578 128.381l46.3-6.566m-46.3-36.376l46.3-5.89"
          fill="none"
          stroke="#000"
    ...
    <g clipPath="url(#d)" transform="matrix(1.33333 0 0 -1.33333 0 1056)">
      ...
      <path id="temporaryHitPointsFill"
            d="M228.481 484.891h155.036c0 2.538 4.453 3.92 4.453 3.92v44.961h-2.579s-2.11-3.95-8.906 0h-140.97c-6.795-3.95-8.906 0-8.906 0h-2.579v-44.96s4.451-1.383 4.451-3.92"
            fill="#fff"
      />
    </g>
    <text
