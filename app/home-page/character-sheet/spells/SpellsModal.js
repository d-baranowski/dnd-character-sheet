...
class EditMode extends React.PureComponent {
  state = {
    ...
    spellDesc: Array.isArray(this.props.spell.content)
      ? this.props.spell.content.join('\n\n')
...
class SpellsModal extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <Modal open={modalOpen} onClose={this.onClose}>
        {canEdit && (
          <svg
        ...
        {(!edit && <ViewMode spell={spell} />) || (
          <EditMode handleChange={this.props.onChange} spell={spell} />
        )}
      </Modal>
    );
  }
