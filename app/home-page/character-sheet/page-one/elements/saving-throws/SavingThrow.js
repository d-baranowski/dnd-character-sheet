...
const SavingThrow = ({ transformY, name, isProficient, savingThrow }) => (
  <g transform={`translate(0 ${transformY})`}>
    <g transform="matrix(1.33333 0 0 -1.33333 0 1056)">
      ...
      />
      <path
        id="strenghtDotBorder"
        d="M104.33 577.363a3.332 3.332 0 0 0-3.33 3.329 3.332 3.332 0 0 0 3.33 3.329 3.332 3.332 0 0 0 3.33-3.33 3.332 3.332 0 0 0-3.33-3.328m0 5.942a2.615 2.615 0 0 1-2.614-2.613 2.616 2.616 0 0 1 2.613-2.613 2.617 2.617 0 0 1 2.614 2.613 2.616 2.616 0 0 1-2.614 2.613"
      />
    </g>
    <path
