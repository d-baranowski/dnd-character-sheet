...
import {
  ...
  deleteChosenFeat,
  editChosenFeat
} from './state/featuresAndTraitsActions';
...
class EditMode extends React.PureComponent {
  state = {
    ...
    featDesc: Array.isArray(this.props.feat.desc)
      ? this.props.feat.desc.join('\n\n')
  ...
  render() {
    ...
    return (
      <Modal open={modalOpen} onClose={this.onClose}>
        ...
        {(!edit && <ViewMode feat={feat} />) || (
          <EditMode handleChange={this.props.onChange} feat={feat} />
        )}
      </Modal>
    );
  }
