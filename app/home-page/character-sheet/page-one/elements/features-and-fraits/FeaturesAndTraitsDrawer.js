    ...
    const matchingFeats = [
      {
        name: 'New',
        desc:
          'Press the quill icon in the top right corner to customise this feature.'
      },
      ...allPossibleValues.filter(feat =>
        feat.name.toUpperCase().includes(this.props.searchTerm.toUpperCase())
      )
    ];
...
export default drawerRoute(FeaturesAndTraitsDrawerRoute)(
  connect(mapStateToProps, mapDispatchToProps)(FeaturesAndTraitsDrawer)
);
