...
const Presentation = ({ isHovered, characterName }) => (
  <g>
    <g filter={isHovered && 'url(#sofGlow)'}>
      ...
      />
      <path
        id="top-banner-nav-start-piece-border"
      ...
      />
      <path
        id="top-banner-nav-start-shadow-piece"
        d="M87.877 75.909L55.585 71.13v50l32.292 4.778z"
        fill="#c3c4c6"
      />
      <path
        id="top-banner-nav-start-shadow-border"
        d="M87.877 75.909L55.585 71.13v50l32.292 4.778z"
        fill="none"
        stroke="#000"
        strokeWidth={1.83332875}
