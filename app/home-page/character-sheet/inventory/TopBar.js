...
import TotalWeight from "./top-bar/TotalWeight";
import Encumbered from "./top-bar/Encumbered";
import HeavilyEncumbered from "./top-bar/HeavilyEncumbered";
import PushAndLift from "./top-bar/PushAndLift";
import CarryingCapacity from "./top-bar/CarryingCapacity";
import Status from "./top-bar/Status";
...
const TopBar = () => (
  <g>
    <g id="top-bar">
      ...
      <path fill="none" stroke="#000" strokeMiterlimit="10" strokeWidth="1.77" d="M259.42 753.06V679.8c1.04 2.52 2.1 3.57 2.1 3.57v66.13s-1.06 1.04-2.1 3.56" transform="matrix(1.33333 0 0 -1.33333 0 1056)"/>
      <path fill="none" stroke="#000" strokeMiterlimit="10" strokeWidth="1.77" d="M261.51 738.87s1.07 10.33 8.4 10.33h22s7.17-2.45 20.5-2.45M261.51 694s1.07-10.33 8.4-10.33h22s7.17 2.44 20.5 2.44" transform="matrix(1.33333 0 0 -1.33333 0 1056)"/>
      <path fill="none" stroke="#000" strokeMiterlimit="10" strokeWidth="1.77" d="M575.4 738.87s-1.06 10.33-8.4 10.33h-22s-7.16-2.45-20.5-2.45M575.4 694s-1.06-10.33-8.4-10.33h-22s-7.16 2.44-20.5 2.44" transform="matrix(1.33333 0 0 -1.33333 0 1056)"/>
      <path fill="none" stroke="#000" strokeMiterlimit="10" strokeWidth="1.06" d="M553.5 746.75c-5.2-.9-11.46-1.92-17.2-1.92H300.62c-5.74 0-12 1.01-17.2 1.92m0-60.64c5.2.9 11.46 1.92 17.2 1.92H536.3c5.74 0 12-1.01 17.2-1.92" transform="matrix(1.33333 0 0 -1.33333 0 1056)"/>
      <path fill="#fff" d="M577.5 753.06V679.8c-1.04 2.52-2.1 3.57-2.1 3.57v66.13s1.06 1.04 2.1 3.56" transform="matrix(1.33333 0 0 -1.33333 0 1056)"/>
      <path d="M577.5 753.06V679.8c-1.04 2.52-2.1 3.57-2.1 3.57v66.13s1.06 1.04 2.1 3.56" transform="matrix(1.33333 0 0 -1.33333 0 1056)"/>
      <path fill="none" stroke="#b5b6b6" strokeWidth=".46666549999999996" d="M353.33 89.1h410.4M353.33 123.87h410.4"/>
    </g>
    <TotalWeight/>
    <g>
      <text
    ...
    <PushAndLift/>
    <CarryingCapacity/>
    <text id="legal-info" fill="#bfbfbf" fontFamily="Interstate Light" fontSize="5.5" fontWeight="300"  transform="matrix(1.33333 0 0 1.33333 230.6 1038.6)">
      <tspan x="0 3.23 7.57 9 12.54 13.97 18.57 20 23.13 26.66 28.37 31.81 33.24 37.95 39.33 42.04 45 47.24 50.31 52.88 54.31 57.42 59.38 60.81 62.86 65.98 68.95 70.38 73.83 76.94 79.91 82.48 84.52 85.95 89.12 92.28 95.73 97.05 98.48 101.88 104.85 107.09 111.75 113.13 115.7 118.27 119.65 122.76 125.88 127.31 128.69 131.26 132.69 135.77 138 140.97 144.09 146.13 149.1 152.18 153.61 155.65 158.77 160.2 163.27 166.39 169.5 171.55 174.66 177.38 180.5 183.57 186.49 187.92 189.97 193.09 194.47 197.03 198.47 201.54 204.65 207.38 210.49 215.16 218.13 221.25 223.29 224.72 226.68 229.79 232.03 233.46 236.53 239.5 241.74 244.31 247.42 250.54 253.51 254.89 256.32 259.44 262 264.98" y="0">TM &amp; © 2014 Wizards of the Coast LLC. Permission is granted to photocopy this document for personal use.</tspan>
    </text>
