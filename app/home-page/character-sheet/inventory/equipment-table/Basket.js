...
const Basket = ({
  ...
  <g transform={transform}>
    ...
    {basket &&
      paginate(Object.values(basket), 11, basketPage).map((val, index) => (
        <React.Fragment>
          <foreignObject x="76" y={715.2 + index * 20}>
            <div
              style={{
                height: '20px',
                width: '184px',
          ...
          <foreignObject x="260" y={715.2 + index * 20}>
            <div
              style={{
                height: '20px',
                width: '65px',
          ...
          <foreignObject x="325" y={715.2 + index * 20}>
            <div
              style={{
                height: '20px',
                width: '63px',
    ...
    {basketPage !== 1 && (
      <LeftArrow
        onClick={() => decrementPage(basketName)}
        x={219 - 93}
        y={945}
      />
    )}
    ...
    {basketMax &&
      basketPage < basketMax && (
        <RightArrow
          onClick={() => incrementPage(basketName)}
          x={219 + 82}
          y={945}
        />
      )}
